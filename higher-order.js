...
/*
  Use the filter method on mixedNumbers to make a new array of just the even 
  numbers.
...
const evenNumbers = mixedNumbers.filter(num => num.length = (num % 2 === 0));
...
//Code Here
let postTaxPrices = prices.map(function(num){
  return prices*1.07;
})
